...
- [Pod Identity for EKS add-ons](https://docs.aws.amazon.com/eks/latest/userguide/add-ons-iam.html)
...
- [Sigstore keyless signing](https://docs.sigstore.dev/cosign/signing/signing_with_blobs/)
...
- [Grafana Tempo Helm installation](https://grafana.com/docs/tempo/latest/setup/helm-chart/)
