...
export function demoData(view: string): unknown {
  ...
  const records: Record<string,unknown> = {
    ...
    cost:{nodes:[{name:'ip-10-0-11-42',instanceType:'t3.medium',capacityType:'SPOT',estimatedHourly:0.0146},{name:'ip-10-0-21-18',instanceType:'t3.medium',capacityType:'SPOT',estimatedHourly:0.0146}],controlPlaneHourly:0.10,loadBalancerHourly:0.0225,natGatewayHourly:0.045,estimatedHourly:0.1967,currency:'USD',disclaimer:'Directional estimate from the validated deployment. Excludes storage, data processing, logs, taxes, discounts, and free-tier credits.',observedAt},
    ...
    settings:{cluster:'kubevista-dev',environment:'portfolio demo',version:'0.2.0',readOnly:true,refreshSeconds:0},
  }
  return records[view]
}
