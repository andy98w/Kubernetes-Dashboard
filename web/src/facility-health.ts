...
export function useFacilityHealth(simulated:boolean){
 ...
 useEffect(()=>{
   ...
   async function refresh(){
     if(simulated){const demo:Signal={state:'unknown',detail:'No live cluster is being probed.'};setHealth({control:demo,services:demo,telemetry:demo,observedAt:''});return}
